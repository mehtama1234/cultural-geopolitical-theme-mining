...
### 3. Staying with a bank can save effort while giving up interest
...
### 5. Earning more does not always mean having more room
...
### 6. A cash benefit can change the household budget and the economic mood
...
### 7. Childcare can be a bill, a lost workday, or an unpaid family shift
...
### 9. Competition helps only when customers can use it
...
### 10. The loss is only the first part of a fraud victim’s experience
...
### 11. A financial record can become part of the next hardship
...
### 12. A faster answer is not yet a remedy
...
### 13. The vote may respond more to lost buying power than to inflation alone
...
### 14. Help can restore service without proving household stability
...
[Read the HTML page](../site/us-energy-assistance-delayed-sacrifice-matched-evidence-001.html) · [Read the Markdown memo](analysis/findings/us-energy-assistance-delayed-sacrifice-matched-evidence-001.md)

### 15. An energy bill can take food, medicine, or safe temperature first
...
### 16. Family help can catch one fall by moving it to another household
...
### 17. A medical cost can change care, work, and debt in different ways
...
### 18. Health coverage can hold a job in place
...
### 19. The first price can shape the choice before the full price appears
...
### 20. Insurance can turn a place risk into a staying problem
...
### 21. The same energy bill means different things in different homes
...
### 24. The inflation average is not the household basket

**Theme:** Cost / customer / voice
**Route:** price index + wage + spending → household basket
**Still open:** same-household substitution, debt, trust, and vote

The official data show why a broad inflation number cannot stand in for household experience. BLS reports that average consumer units spent 1.8% more in 2024 while prices rose 2.9%, which means average real spending fell 1.1%. The same report says housing took a larger share of spending. BLS also publishes real earnings and separate price categories, but these records are not joined into one person's rent, wage, food basket, debt, and choices.  The deeper finding is about measurement. “People are under pressure” can be true while the size and source of pressure differ by household. The low-income renter facing food and rent increases is not represented by the same basket as a high-income owner spending more on other goods.
...
### 25. Slower inflation can still feel like a continuing loss
...
### 26. A business application is not yet a local job or a local place
...
### 27. The same income can buy a different life by place
...
### 28. A visible listing does not prove a safe product
...
### 29. A seller name is only useful if it helps the customer recover
...
### 30. Removing a medical debt can repair the record without repairing the illness
...
### 31. Reviews can reveal quality and distort choice at the same time
...
### 32. One cash pool can protect a family by shrinking a business
...
### 34. Seller visibility can become a customer cost
...
### 35. A data rule can open the market and weaken the data supply
...
### 36. A useful product can still sit inside a power problem
...
### 37. Privacy protection can open the door to more sharing
...
### 38. A recall succeeds only when the household can act
...
### 39. A rent guarantee claim is a process, not a rescue payment
...
### 41. Rent insurance may protect a home before the crisis, but access is the problem
...
### 42. Rent guarantee products open the lease, but may leave the loss with the tenant
...
### 43. Rent guarantee is not one product
...
### 44. Rent guarantee changes when the state changes
...
### 45. Rent aid can buy time; a lawyer can change the case
...
### 46. The person paying the bill may not control the fix
...
### 47. Repeated help is a signal, not yet a diagnosis
...
### 48. Replacement is a second price after repair fails
...
### 49. The cost of a bad choice begins after the review
...
### 50. Repair access is part of the product's real price
...
### 51. A safe temperature can compete with food and medicine
...
### 52. A benefit can be lost without the need going away
...
### 53. A recovery loan can keep a local option open, but it creates another bill
...
### 54. A wider small-business rule can push the smallest firms out
...
### 55. A tariff reaches the household through a chain, not a single price
...
### 56. The same dollar can do different work depending on how it arrives
...
### 57. A manageable yearly cost can still fail at the due date
...
### 58. An old utility balance can make the next move more expensive
...
### 59. The cost of entering utility service can become a credit gate
...
### 60. A smoother bill can move the problem rather than end it

**Theme:** Energy / cost / finance / voice
**Route:** payment plan → smoother bill → true-up or stable service
**Still open:** whether smoothing lowers burden or delays it

Budget billing changes when a household pays, not necessarily how much it owes.  A utility can estimate the cost of a season, divide it into average monthly payments, and later adjust the account for the difference between estimated and actual use. This can be valuable for a household whose income is steady but whose energy use rises sharply in winter or summer. A predictable payment is easier to plan than a large surprise bill.  But the smoother number can hide the account's running balance. If use is higher than expected, the household may reach the end of the plan owing a true-up. If the payment is taken automatically, the withdrawal can also arrive before a paycheck or alongside rent, food, and medicine. The plan may reduce the shock this month while creating a less visible shock later.  The fair question is therefore not whether the monthly payment is lower. It is whether the plan leaves the household with a manageable total cost and a clear path through the next adjustment.
...
### 61. A shutoff rule changes the time a household has to recover
...
### 62. A car repair can protect access while taking away other room
...
### 63. Efficiency savings are real but smaller than the promise
