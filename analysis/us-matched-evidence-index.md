...
### 2. A financial record can become part of the next hardship
...
### 3. A faster answer is not yet a remedy
...
### 4. The vote may respond more to lost buying power than to inflation alone
...
### 5. An energy bill can take food, medicine, or safe temperature first
...
### 6. A medical cost can change care, work, and debt in different ways
...
### 7. Health coverage can hold a job in place
...
### 8. Insurance can turn a place risk into a staying problem
...
### 9. A yearly income can hide an unsafe month
...
### 10. The data can show groups, but not yet the same family over time
...
### 11. The inflation average is not the household basket
...
### 12. Slower inflation can still feel like a continuing loss
...
### 13. A business application is not yet a local job or a local place
...
### 14. The same income can buy a different life by place
...
### 15. Removing a medical debt can repair the record without repairing the illness
...
### 16. One cash pool can protect a family by shrinking a business
...
### 17. Payment choice is a distribution question, but not yet a household welfare result
...
### 18. A rent guarantee claim is a process, not a rescue payment
...
### 19. Four states show four different levels of visibility
...
### 20. Rent insurance may protect a home before the crisis, but access is the problem
...
### 21. Rent guarantee products open the lease, but may leave the loss with the tenant
...
### 22. Rent guarantee is not one product
...
### 23. Rent guarantee changes when the state changes
...
### 24. Rent aid can buy time; a lawyer can change the case
...
### 25. A benefit can be lost without the need going away
...
### 26. A recovery loan can keep a local option open, but it creates another bill
...
### 27. A wider small-business rule can push the smallest firms out
...
### 28. A tariff reaches the household through a chain, not a single price
...
### 29. The same dollar can do different work depending on how it arrives
...
### 30. A car repair can protect access while taking away other room
