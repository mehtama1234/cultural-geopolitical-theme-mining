...
### 9. Insurance can turn a place risk into a staying problem
...
### 10. A yearly income can hide an unsafe month
...
### 11. The data can show groups, but not yet the same family over time
...
### 12. The inflation average is not the household basket
...
### 13. Slower inflation can still feel like a continuing loss
...
### 14. A business application is not yet a local job or a local place
...
### 15. The same income can buy a different life by place
...
### 16. Removing a medical debt can repair the record without repairing the illness
...
### 17. One cash pool can protect a family by shrinking a business
...
### 18. Payment choice is a distribution question, but not yet a household welfare result
...
### 19. A rent guarantee claim is a process, not a rescue payment
...
### 20. Four states show four different levels of visibility
...
### 21. Rent insurance may protect a home before the crisis, but access is the problem
...
### 22. Rent guarantee products open the lease, but may leave the loss with the tenant
...
### 23. Rent guarantee is not one product
...
### 24. Rent guarantee changes when the state changes
...
### 25. Rent aid can buy time; a lawyer can change the case
...
### 26. A benefit can be lost without the need going away
...
### 27. A recovery loan can keep a local option open, but it creates another bill
...
### 28. A wider small-business rule can push the smallest firms out
...
### 29. A tariff reaches the household through a chain, not a single price
...
### 30. The same dollar can do different work depending on how it arrives
...
### 31. A car repair can protect access while taking away other room
