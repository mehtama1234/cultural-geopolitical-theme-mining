...
### 6. Health coverage can hold a job in place
...
### 7. Insurance can turn a place risk into a staying problem
...
### 8. A yearly income can hide an unsafe month
...
### 9. The data can show groups, but not yet the same family over time
...
### 10. The inflation average is not the household basket
...
### 11. Slower inflation can still feel like a continuing loss
...
### 12. A business application is not yet a local job or a local place
...
### 13. The same income can buy a different life by place
...
### 14. Removing a medical debt can repair the record without repairing the illness
...
### 15. One cash pool can protect a family by shrinking a business
...
### 16. Payment choice is a distribution question, but not yet a household welfare result
...
### 17. A rent guarantee claim is a process, not a rescue payment
...
### 18. Four states show four different levels of visibility
...
### 19. Rent insurance may protect a home before the crisis, but access is the problem
...
### 20. Rent guarantee products open the lease, but may leave the loss with the tenant
...
### 21. Rent guarantee is not one product
...
### 22. Rent guarantee changes when the state changes
...
### 23. Rent aid can buy time; a lawyer can change the case
...
### 24. A benefit can be lost without the need going away
...
### 25. A recovery loan can keep a local option open, but it creates another bill
...
### 26. A wider small-business rule can push the smallest firms out
...
### 27. A tariff reaches the household through a chain, not a single price
...
### 28. The same dollar can do different work depending on how it arrives
...
### 29. A car repair can protect access while taking away other room
