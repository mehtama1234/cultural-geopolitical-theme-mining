...
### 5. Health coverage can hold a job in place
...
### 6. Insurance can turn a place risk into a staying problem
...
### 7. A yearly income can hide an unsafe month
...
### 8. The data can show groups, but not yet the same family over time
...
### 9. The inflation average is not the household basket
...
### 10. Slower inflation can still feel like a continuing loss
...
### 11. A business application is not yet a local job or a local place
...
### 12. The same income can buy a different life by place
...
### 13. Removing a medical debt can repair the record without repairing the illness
...
### 14. One cash pool can protect a family by shrinking a business
...
### 15. Payment choice is a distribution question, but not yet a household welfare result
...
### 16. A rent guarantee claim is a process, not a rescue payment
...
### 17. Four states show four different levels of visibility
...
### 18. Rent insurance may protect a home before the crisis, but access is the problem
...
### 19. Rent guarantee products open the lease, but may leave the loss with the tenant
...
### 20. Rent guarantee is not one product
...
### 21. Rent guarantee changes when the state changes
...
### 22. Rent aid can buy time; a lawyer can change the case
...
### 23. A benefit can be lost without the need going away
...
### 24. A recovery loan can keep a local option open, but it creates another bill
...
### 25. A wider small-business rule can push the smallest firms out
...
### 26. A tariff reaches the household through a chain, not a single price
...
### 27. The same dollar can do different work depending on how it arrives
...
### 28. A car repair can protect access while taking away other room
