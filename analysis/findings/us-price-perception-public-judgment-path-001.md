...
A slower rise in prices can still feel like a continuing loss when wages have not caught up and cheaper choices are no longer cheap. People often judge the economy through the items they buy again and again, not through one national number. A national rate describes how quickly prices are changing; it does not restore the price level a household has already absorbed.

This is not only a matter of mood. A family may buy less, switch stores, save less, use credit, or stock up because it believes buying power is falling. Those choices can change how it sees a brand, a government, or the future. But a survey belief is not a transaction, and a changed purchase is not automatically a vote. The important bridge is what the household had to give up and whom it held responsible.
...
The household may experience this as a sequence rather than one crisis. First, a familiar item gets smaller or costs more. Then the family changes stores or buys a less useful substitute. Next, a fixed bill leaves less room for savings. When a car repair or medical bill arrives, the family borrows. By the time it answers a survey about the economy, the answer includes the lost buffer, not only the latest price change.
...
→ lost buffer and changed view of firms, government, and the future
→ purchase, trust, or political response
```
...
|---|---|---|---|
| Buying power | Two surveys of representative US samples in an NBER study find people mainly dislike inflation because they believe wages are not keeping up with prices. | The felt problem is the pay–price gap, not only the rate of price change. | Reported belief is not a complete measure of the household budget. |
| Shopping response | Those beliefs are linked to reported changes in shopping and saving choices. | Economic belief can sit near household action. | The source does not prove that the belief caused each reported action. |
| Cheap options | HBS reports the cheapest US food products in its study rose 30% from January 2020 to May 2024, compared with 22% for the most expensive foods. | Trading down may not protect the budget as before. | The comparison is for the products and period studied, not every food purchase. |
| Customer judgment | HBS research links price increases to fairness, value, and demand. | A higher price changes what a customer thinks is worth buying. | A fairness judgment does not by itself identify who set the price or whether it was avoidable. |
| Limits | The sources do not join one household's prices, wages, purchases, media exposure, trust, and political action over time. | The public-judgment link remains an inference. | A changed survey answer should not be called a vote or a firm response without observed behavior. |
...
The deeper issue is the shrinking of safe choices. Before the price shock, a family may have had a budget brand, a small savings balance, and room to handle a repair. After several increases, those choices disappear one by one. The family may still be buying the same broad categories, but it is doing so with less slack. That loss of slack is what connects checkout experience to trust and political judgment.
