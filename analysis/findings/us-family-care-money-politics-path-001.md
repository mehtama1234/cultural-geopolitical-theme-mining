...
Family care is work, but it is often counted first as private time. When a person helps an older relative, the change may show up in work hours, earnings, savings, or the need for paid help before it appears in an economic report. The family may keep the older person safe while the caregiver loses room in the rest of life.
...
An NBER study links reported family caregiving to administrative earnings records over 25 years and finds different labor effects by gender. This is evidence that care and work can be connected over time, not proof that every caregiver loses earnings or leaves work. The long period matters because a short leave may become a slower wage path, fewer promotions, or a later return to work.

The sources do not measure the same person's full care cost, savings, debt, health, housing, trust, and political action. They also do not show how care is divided among relatives or how much paid care would have cost.

- [BLS unpaid eldercare release](https://www.bls.gov/news.release/elcare.htm)
- [BLS American Time Use Survey data](https://www.bls.gov/tus/data/datafiles-0325.htm)
- [NBER Working Paper 31450](https://www.nber.org/papers/w31450)
- [HHS review of caregiver tax credits](https://aspe.hhs.gov/reports/caregiver-tax-credit)

## The connection

```text
need for family care
  -> unpaid time, paid care, or both
  -> work hours, earnings, and travel change
  -> savings, debt, health, or housing room changes
  -> view of employers and public support changes
  -> demand for a different care rule
```

Care can be a burden, but it can also be chosen, loving, and useful. The question is who can absorb the time and who must give up work or pay for help.

The deeper connection is to household slack. A caregiver may keep every bill current while losing sleep, work hours, savings, or the ability to change jobs. A family may avoid a paid-care bill by moving in a relative or using unpaid time. The household appears less expensive because the cost has been moved into one person’s future earnings and health.
...
- Work hours, earnings, job changes, leave, and promotion over time.
- Paid care, travel, health, debt, savings, and housing costs.
- Employer support, public benefits, caregiver tax credits, and actual use.
- Differences by gender, income, race, age, disability, family structure, and place.
- Trust, complaints, local policy, and political action after a care shock.
...
Do not call family care an economic loss without measuring what it provided. Do not call it free without measuring whose time, income, and future choices carried it.
