...
People may respond to what their pay can buy, not simply to the inflation rate in a national report. If local prices rise faster than local pay, a household can lose room even while another household in the same county gains.

But a county result is not a voter interview. A person may blame prices, a party, immigration, a local employer, or a national leader. They may feel poorer and vote on another issue. They may change shopping or saving without changing a vote. The evidence is strongest for a place-level economic pattern and weaker for the path from one household’s bills to one ballot.
...
→ blame, trust, and economic judgment → turnout, vote choice, or support for change
```
...
|---|---|---|
| Local outcomes | An NBER study uses county-level family-budget costs, nominal income, and presidential and congressional results from 2021 to 2024. | Local economic conditions can be compared with election results. |
| Real pay | The study reports declining real wages—not higher inflation alone—predicted Republican gains, while inflation remained associated with presidential vote share after accounting for real wages. | Lost buying power may matter differently from inflation by itself. |
| Belief | Separate NBER survey work finds people dislike inflation mainly when they believe wages do not keep up with prices. | The wage-price comparison is part of the political feeling. |
| Behavior | That survey belief relates to reported shopping and saving choices. | Economic judgment can reach daily behavior before any vote. |
| Limits | The county and survey studies describe related pieces, not the same household from prices to a vote. | A place pattern is not an individual causal story. |

Sources: [NBER Working Paper 35301](https://www.nber.org/papers/w35301) and [NBER Working Paper 32300](https://www.nber.org/papers/w32300).
...
Do not say voters punish inflation when the evidence may show lost real pay. Do not turn a county pattern into a story about every voter.
