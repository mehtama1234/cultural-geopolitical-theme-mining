...
- The same borrower's payment, default, score recovery, and later applications.
- Rent, mortgage, insurance, job, utility, and service outcomes.
- Differences by income, race, age, place, prior record, and access to cash.
- A comparison of the current score rule with a rule that ignores harmless inquiry timing.
