...
A tariff can reach a US household in stages. The importer may pay more first. A retailer or producer may absorb part of the cost, change suppliers, or raise a shelf price later. Domestic firms may then raise their own markup when imported competition becomes weaker.
...
An NBER study of 2025 US tariffs estimates that about 90% of the tariff was passed into the tariff-inclusive price paid by US importers. That is a strong first link, but it is not a retail bill.

[NBER Working Paper 35064](https://www.nber.org/papers/w35064)

### 2. The shelf price rose partly and unevenly

Another NBER study matches daily prices, product origin and tariff rates. It estimates about 20% retail pass-through for the 2025 tariffs and a roughly 0.7 percentage-point contribution to all-items CPI by September 2025. Imported goods rose about twice as much as domestic goods in that study.

[NBER Working Paper 34496](https://www.nber.org/papers/w34496)

An HBS tracker using nearly 360,000 products at five large US retailers estimated that consumers carried 43% of the tariff burden after seven months, with firms carrying the rest.
...
[NBER Working Paper 35561](https://www.nber.org/papers/w35561)
...
tariff decision
  -> importer cost
  -> supplier change, firm margin, or domestic competition
  -> shelf price now or later
  -> household substitution, delay, or lower spending room
  -> firm, worker, regulator, and voter response
```

The first three price links have evidence. The household, job and political links remain open.
...
- The same product from import entry through wholesale, retail and household purchase.
- Prices, quantities, package size, quality and product choice by income and region.
- Firm margins, supplier changes, domestic output, jobs and wages.
- Household records showing trading down, delayed purchases, borrowing or lost care.
- A test of whether people knew the price change was tariff-related and whether that changed policy support or voting.
- Evidence from a tariff rollback or a similar product not exposed to the rule.
...
The importer cost is not the checkout price. The checkout price is not the household loss. A price result is not a job result or a vote result.
