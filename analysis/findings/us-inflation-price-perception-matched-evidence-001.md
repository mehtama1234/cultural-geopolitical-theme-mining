...
```text
price level rises
  -> repeated household adjustment
  -> less buying power or weaker substitutes
  -> food, housing, debt, care, and trust change
  -> public blame or political response
```
...
|---|---|---|
| A slower inflation rate still leaves prices higher than before. | “Cooling” is not a price reversal. | The headline does not describe each household’s basket. |
| NBER finds people mainly dislike inflation when they think wages are not keeping up with prices. | The felt problem is the pay–price gap. | It does not identify each family’s fixed costs. |
| HBS reports the cheapest food products in its study rose 30% from January 2020 to May 2024, versus 22% for the most expensive foods. | Trading down may not protect the budget as before. | The study’s products are not every food purchase. |
| HBS research links price increases to fairness, value, and demand. | A higher price changes what a customer thinks is worth buying. | A fairness judgment is not the same as a vote. |
| The sources do not follow one family’s basket to trust, blame, and voting. | The political link remains an open test. | Economic pressure is not yet a vote explanation. |
...
Do not say “inflation is falling, so pressure is over.” Ask whether prices fell, pay caught up, or the household simply found less room.
