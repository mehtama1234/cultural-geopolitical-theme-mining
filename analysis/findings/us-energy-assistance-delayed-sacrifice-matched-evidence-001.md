# Energy assistance can restore service without proving stability

## The argument

Energy assistance clearly reaches households in crisis and can restore service. That is an important immediate result. It does not prove the household became stable. The next bill, a broken heater, a rent shortfall, unsafe temperature, skipped medicine, or a missed shift may still be waiting.
...
|---|---|---|
| HHS reports nearly 6 million households helped by LIHEAP in FY24. | The program reaches a substantial crisis population. | Reach does not show whether the next bill was affordable. |
| HHS reports 279,000 instances of restored home energy. | Assistance can reconnect service. | Restoration is not proof of lasting safety. |
| EIA counts unsafe temperature, skipped food or medicine, shutoff notices, and failed equipment as separate reported problems. | Energy pressure can reach basic needs. | Public counts do not follow each family’s full sequence. |
| GAO finds utility costs can leave assisted renters rent-burdened when allowances fall short. | A benefit can help while leaving a housing gap. | The effect varies by place and household. |
| LIHEAP includes heating, cooling, crisis, and weatherization help. | Immediate payment and durable improvement are different tools. | Reports do not show which tool worked for which family. |
...
Do not call assistance a lasting solution because service was restored once. Ask what happened at the next bill and what the household no longer had to give up.
