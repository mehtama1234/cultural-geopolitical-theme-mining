...
| Need/payment → care delay or foregoing | [SHED 2025 care-skipping layer](shed-2025-care-skipping-choice-layer-v1.md), [care-cost/work/family-security layer](care-cost-work-family-security-layer-v1.md), and [coverage-transition care-foregoing layer](shed-panel-coverage-care-foregoing-paths-v1.md) | Reported / compared; longitudinal descriptive | Cost-related care skipping is a measurable population route: 26% overall, 38% below $25,000 income, 13% at $100,000+, and 45% uninsured versus 24% insured; the panel shows stable coverage and changing coverage states have different care-foregoing paths | Exact bill, condition, alternative, treatment outcome, or non-user counterfactual; coverage fields do not measure plan adequacy or access | Join reported unmet need to event, reason, coverage, benefit design, and later treatment continuity |
...
| Institutional route → remedy | [CFPB medical-collections credit-response layer](cfpb-medical-collections-credit-response-layer-v1.md), [randomized medical-debt relief RCT](medical-debt-relief-rct-outcome-separation-v1.md), and [consumer recourse/public-system lanes](../us-customer-automation-recourse/README.md) | Official institutional record / randomized response evidence | Medical debt can become a credit signal; reporting changes can remove or delay some signals; randomized relief produces modest credit-access effects under reporting exposure, no detected average health/care/wellness repair, and a distinct repayment response | The provider/insurer/collector response to the same health-cost episode, and whether repair reaches household health, security, trust, or exit | Preserve case ID, effort, response, correction, repeat contact, credit/housing/work effect, and exit |
