...
The coverage-transition row is now backed by the [SHED reproduction audit](shed-panel-coverage-care-foregoing-reproduction-audit-2026-09-16.md)
and a canonical record that carries care paths together with 2025 medical
debt, reduced savings, borrowing, delayed purchases, and perceived-health
measures. This strengthens the coverage → care → adaptation segment while
leaving the dated need, plan adequacy, treatment continuity, and recovery
arrows open.
