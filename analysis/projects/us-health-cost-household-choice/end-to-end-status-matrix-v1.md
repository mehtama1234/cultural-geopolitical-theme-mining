...
| Care foregoing → household adaptation | [SHED care-skipping/adaptation association](shed-2025-care-skipping-adaptation-association-v1.md); [amount-conditioned care-choice association](shed-2025-unexpected-expense-amount-care-choice-association-v1.md) | Same-respondent reported / compared | Respondents reporting any care skipped also report higher medical debt, unexpected medical expense, borrowing, reduced savings, delayed purchases, work adaptation, and outside-household support; amount bands separate some care-foregoing and debt patterns without producing a monotonic choice gradient | Timing, causal direction, exact bill, alternative, protected outcome, treatment consequence, and institutional remedy | Separate care need, bill, coverage, amount, support, and adaptation timing in a same-unit episode |
