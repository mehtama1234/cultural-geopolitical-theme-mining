...
| Need/payment → care delay or foregoing | [SHED 2025 care-skipping layer](shed-2025-care-skipping-choice-layer-v1.md) and [care-cost/work/family-security layer](care-cost-work-family-security-layer-v1.md) | Reported / compared | Cost-related care skipping is a measurable population route: 26% overall, 38% below $25,000 income, 13% at $100,000+, and 45% uninsured versus 24% insured; the separate 2024→2025 annual comparison is 28%→26% overall and 45%→45% among uninsured adults | Exact bill, condition, alternative, treatment outcome, or non-user counterfactual; annual movement is not a same-person panel | Join reported unmet need to event, reason, coverage, and later treatment continuity |
| Care foregoing → household adaptation | [SHED care-skipping/adaptation association](shed-2025-care-skipping-adaptation-association-v1.md) | Same-respondent reported / compared | Respondents reporting any care skipped also report higher medical debt, unexpected medical expense, borrowing, reduced savings, delayed purchases, and work adaptation; coverage conditioning shows high residual debt among both insured and uninsured skippers | Timing, causal direction, exact bill, alternative, protected outcome, and treatment consequence | Separate care need, bill, coverage, and adaptation timing in a same-unit episode |
