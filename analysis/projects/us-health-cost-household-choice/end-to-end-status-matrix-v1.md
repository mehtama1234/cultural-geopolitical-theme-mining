...
| Household burden → trust/action/exit | [Health-cost institutional-legitimacy bridge](health-cost-institutional-legitimacy-bridge-v1.md), [ANES health-cost legitimacy acquisition audit](anes-health-cost-legitimacy-acquisition-audit-v1.md), [health-cost matched finding](../../findings/us-health-cost-household-choice-matched-evidence-001.md), and [material-to-trust/action bridge](../../records/us-material-to-trust-action-bridge-2022-2025.json) | Inferred across sources / open; ANES acquisition boundary | SHED, CFPB, Census, and ANES provide separate household-burden, institutional-response, health-cost-concern, and trust/action surfaces; ANES narrows the endpoint design with health-care payment concern and policy-demand variables | That a medical cost caused distrust, voting, switching, or collective action for the same person or episode; ANES lacks bill, care-choice, remedy, and attribution fields | Acquire/run the ANES health-cost concern tables, then seek a dated health-cost episode source with attribution and remedy effort |
