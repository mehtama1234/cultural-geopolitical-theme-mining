...
| Institutional route → remedy | [CFPB medical-collections credit-response layer](cfpb-medical-collections-credit-response-layer-v1.md) and [consumer recourse/public-system lanes](../us-customer-automation-recourse/README.md) | Official institutional record / separate response evidence | Medical debt can become a credit signal; reporting changes can remove or delay some signals; federal medical-debt rulemaking was contested and vacated | The provider/insurer/collector response to the same health-cost episode, and whether credit visibility or removal repaired household welfare | Preserve case ID, effort, response, correction, repeat contact, credit/housing/work effect, and exit |
