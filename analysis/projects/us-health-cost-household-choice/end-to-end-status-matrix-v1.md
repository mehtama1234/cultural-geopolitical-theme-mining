...
| Need/payment → care delay or foregoing | [Care-cost/work/family-security layer](care-cost-work-family-security-layer-v1.md) and SHED reported care evidence | Reported / open | Cost-related care skipping is a measurable population route and varies with resources | Exact bill, condition, alternative, treatment outcome, or non-user counterfactual | Join reported unmet need to event, reason, coverage, and later treatment continuity |
