...
| Dated event → same-person care/debt context | [MEPS dated event-to-household-response screen](meps-dated-cascade-event-screen-v1.md) | Strict inter-round event windows now sit beside R4/2 care delay, bill problems, medical debt, and collector contact, with payment and BRR uncertainty kept on the event/person route. | Claim-level obligation, household adaptation timing, remedy, and recovery |
