...
| Dated event + friction → burden context | [MEPS dated friction cascade](meps-dated-friction-cascade-v1.md) | Strict-window descriptive comparison with private-coverage/low-room screens | Denial/prior-authorization reporters show higher weighted care-delay, bill-problem, debt, and collector-contact context across office, ER, and inpatient event families; the contrast remains visible in practical-room strata | Claim-level denial date, causal direction, alternative, remedy, and recovery |
...
| Adaptation → persistence/recovery | SHED 2024–2025 recontact panel; [MEPS R5/3 event follow-up](meps-event-six-month-followup-v1.md) | Longitudinal descriptive; later-panel transitions | Adaptations may persist when broad financial condition improves; same-person event windows can now be carried from R4/2 baseline health/work status to R5/3 levels and conditional transitions | Dated trigger, same adaptation, remedy date, and material recovery from that episode |
| Health event → payment/context | MEPS dated event spine, staged ledger, and [later-panel follow-up](meps-event-six-month-followup-v1.md) | Observed bounded event frame with ordered follow-up | 18,457 positive-weight keyed-hash first-event rows populate event month, payment, coverage/poverty, employment, perceived health, and bill context; strict-window events have later R5/3 health/work outcomes without direct identifiers in Git | Claim/bill identity, household payer, exact obligation, care choice, and event-specific remedy/follow-up |
| Burden → institutional route | [MEPS denial/prior-authorization later-panel screen](meps-friction-later-panel-v1.md); CFPB receipt/routing/response layers | Institutional visibility and later-status association, not remedy | Denial context, complaint receipt, routing lag, timeliness, response category, public-response visibility, and later health/work transitions are measurable | Same case/account effort, authority, appeal, correction, refund, coverage/service restoration, and repeat contact |
...
| Persistence/recovery | Partial: same-person later health/work transitions now observed; no verified episode recovery | [MEPS later-panel follow-up](meps-event-six-month-followup-v1.md); [SHED persistence route](../us-household-financial-pressure/shed-2024-2025-panel-persistence-layer-v1.md) |
