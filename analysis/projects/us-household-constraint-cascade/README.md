...
- [MEPS dated event-to-household-response screen](meps-dated-cascade-event-screen-v1.md), with its [compact output](data-meps-dated-cascade-event-screen-2024.json): inter-round event timing beside care delay, bill problems, debt, collector contact, and R4/2 nonemployment using the valid PERWT/BRR route.
...
- [MEPS event six-month follow-up](meps-event-six-month-followup-v1.md), with its [compact output](data-meps-event-six-month-followup-2024.json): strict-window events carried to later R5/3 health and employment outcomes without treating them as recovery.
- [MEPS event-to-work two-clock audit](meps-event-work-two-clock-audit-v1.md), with its [machine-readable alignment](data-meps-event-work-two-clock-audit-2024.json): R4/2 nonemployment levels placed beside R5/3 levels, status change, onset, and resolution without asserting a row-level merged panel.
- [MEPS prescription-event cascade](meps-prescription-event-cascade-v1.md), with its [compact output](data-meps-prescription-event-cascade-2024.json): a month-ordered prescription event and payment component beside later care, bill, debt, collector, and work-status context.
- [Prescription-event six-month follow-up](meps-prescription-event-six-month-followup-v1.md), with its [compact output](data-meps-prescription-event-six-month-followup-2024.json): the prescription-event group carried from R4/2 to R5/3 health and employment levels and transitions, without treating later status as recovery.
- [MEPS friction-to-later-panel screen](meps-friction-later-panel-v1.md), with its [compact output](data-meps-friction-later-panel-2024.json): reported denial/prior-authorization friction carried to later health and employment transitions.
...
- [Promotion-gate regression test](../../../scripts/test_household_constraint_cascade_promotion.py): verifies rejection of the open fixture and acceptance of a complete synthetic ledger.
