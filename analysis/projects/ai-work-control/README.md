...
The [Warraich remedy follow-up recheck](uber-warraich-remedy-followup-recheck-v1.md)
extends the platform-remedy lane by checking whether the ordered reactivation
and lost-pay direction became a public implementation or payment record. No
subsequent public implementation, payment, or same-worker outcome was located
in the targeted Fair Work Commission search. The case therefore closes at a
...
1. Start with HBS stories on AI adoption, careers, and employee value.
2. Find the linked faculty papers and record their methods.
3. Search NBER labor, productivity, firms, technology, inequality, and political-economy programs.
4. Compare worker, manager, firm, and market outcomes instead of using “AI impact” as one measure.
5. Add company filings and labor evidence only to test the research claims.

## Required findings

- output effect;
- task and skill effect;
- monitoring and bargaining effect;
- wage and promotion effect;
- small-firm versus large-firm effect;
- local and geopolitical effect through labor, capital, and technology dependence.

## Do not assume

- that adoption means productive use;
- that a job count captures control or dignity;
...
- [Finding 009: A written control is not yet lived control](findings/ai-work-control-009.md)
- [Finding 010: The job of the system matters more than the AI label](findings/ai-work-control-010.md)
- [Finding 011: Planning can change before measured output does](findings/ai-work-control-011.md)
...
- [JRC AIM-WORK survey source record](jrc-aim-work-source-record-v1.md)
- [Kenya content-moderation procedural timeline](kenya-content-moderation-procedural-timeline-v1.md)
...
- [Published HTML finding 010](../../../site/ai-work-control/finding-010.html)
- [Published HTML finding 011](../../../site/ai-work-control/finding-011.html)
...
- [Published macro and infrastructure source packet](../../../site/ai-work-control/macro-infrastructure-source-packet.html)
- [Published time-ordered adoption trace](../../../site/ai-work-control/time-ordered-adoption-trace.html)
