# Project: US small-business support and size rules

## Question

Who gains when a program called small-business support reaches larger firms?

## Short first pass

Separate the eligibility rule, firm size, contract or loan received, revenue, exit, wages, innovation, owner household and local customer access.

## Possible connection

The label “small business” hides a fight over scale. A larger eligibility limit may increase the reach of a program while reducing the room available to the smallest firms.
