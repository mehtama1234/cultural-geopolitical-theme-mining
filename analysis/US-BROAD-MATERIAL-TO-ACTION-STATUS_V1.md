...
| **SIPP utility/assistance → food following screen** | 24,297 utility-difficulty, 321,986 no-difficulty, 13,399 energy-assistance, and 178,141 no-assistance person-month pairs; food security evaluated at the following file month | Following food insecurity is 51.13% after utility difficulty versus 8.40% without, and 32.76% after assistance versus 16.93% without; the assistance contrast is compatible with targeted support reaching households already in need | Dated bill or assistance decision, benefit adequacy, food recovery, work/care trade-off, attribution, trust, political action, remedy, and exit; reference-period and repeated-field limits remain |
