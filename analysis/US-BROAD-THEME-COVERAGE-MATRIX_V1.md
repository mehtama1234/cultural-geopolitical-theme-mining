...
| Unequal exposure and status | [Unequal exposure/status layer](US-UNEQUAL-EXPOSURE-STATUS-LAYER_V1.md); [SIPP Fay-BRR race × disability × resource layer](projects/us-household-calendar-integration/sipp-fay-brr-race-disability-resource-layer-v1.md); SIPP race × resource × tenure layer; USDA food security; ATUS time; discrimination, local-price, age, and migration packets | Person, household, place, customer, worker, program episode | Compared / Open | Two three-way person-month comparisons now test race, resource, and tenure or work-limiting condition with replicate-weight uncertainty and documented universes for five outcomes; still test household composition, mechanism, remedy, and downstream outcomes. |
