...
| Unequal exposure and status | [Unequal exposure/status layer](US-UNEQUAL-EXPOSURE-STATUS-LAYER_V1.md); [SIPP Fay-BRR race × children × resource layer](projects/us-household-calendar-integration/sipp-fay-brr-race-children-resource-layer-v1.md); SIPP race × disability × resource and race × tenure × resource layers; USDA food security; ATUS time; discrimination, local-price, age, and migration packets | Person, household, place, customer, worker, program episode | Compared / Open | Three three-way person-month comparisons now test race, resource, tenure, work-limiting condition, or child presence with replicate-weight uncertainty and documented universes for five outcomes; still test direct caregiving, mechanism, remedy, and downstream outcomes. |
...
| Public systems and policy feedback | [Public-aid bridge](bridges/us-public-aid-interpretation-political-response-v1.md); [SIPP SNAP transition × material context](projects/us-safety-net-access/sipp-snap-transition-context-layer-v1.md); [SIPP SNAP transition × reason layer](projects/us-safety-net-access/sipp-snap-transition-reason-layer-v1.md); [SIPP SNAP start/end reason layer](projects/us-safety-net-access/sipp-snap-reason-layer-v1.md); [SIPP SNAP transition layer](projects/us-safety-net-access/sipp-snap-transition-layer-v1.md); [SIPP SNAP × food-security layer](projects/us-safety-net-access/sipp-snap-food-security-layer-v1.md); [safety-net administrative-burden layer](projects/us-safety-net-access/administrative-burden-access-layer-v1.md); benefit, utility, eviction, and assistance findings | Person, household, program spell, agency, place, census tract | Compared / Reported | SNAP receipt is now compared with food security, work, race, child presence, resources, adjacent-month transitions, recorded reasons, and resource/job changes around transitions; add notices, eligibility, burden, application, denial, timing, interruption, and later institutional demand or behavior. |
