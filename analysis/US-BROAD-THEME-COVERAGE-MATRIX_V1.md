...
| Public systems and policy feedback | [Public-aid bridge](bridges/us-public-aid-interpretation-political-response-v1.md); [SIPP SNAP × food-security layer](projects/us-safety-net-access/sipp-snap-food-security-layer-v1.md); [safety-net administrative-burden layer](projects/us-safety-net-access/administrative-burden-access-layer-v1.md); benefit, utility, eviction, and assistance findings | Person, household, program spell, agency, place, census tract | Compared / Reported | SNAP receipt is now compared with food security, work, race, child presence, and resources; add notice, eligibility, burden, application, denial, timing, interruption, and later institutional demand or behavior. |
