...
| Unequal exposure and status | [Unequal exposure/status layer](US-UNEQUAL-EXPOSURE-STATUS-LAYER_V1.md); [SIPP Fay-BRR race × resource × tenure layer](projects/us-household-calendar-integration/sipp-fay-brr-race-tenure-resource-layer-v1.md); SIPP race × resource layer; USDA food security; ATUS time; discrimination, local-price, disability, age, and migration packets | Person, household, place, customer, worker, program episode | Compared / Open | A three-way person-month comparison now tests race, resource, and tenure jointly with replicate-weight uncertainty and documented universes for five outcomes; still test household composition, mechanism, remedy, and downstream outcomes. |
