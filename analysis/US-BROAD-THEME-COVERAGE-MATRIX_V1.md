...
| Unequal exposure and status | [Unequal exposure/status layer](US-UNEQUAL-EXPOSURE-STATUS-LAYER_V1.md); [SIPP Fay-BRR race × resource layer](projects/us-household-calendar-integration/sipp-fay-brr-race-resource-layer-v1.md); SIPP tenure × resource estimates; USDA food security; ATUS time; discrimination, local-price, disability, age, and migration packets | Person, household, place, customer, worker, program episode | Compared / Open | A first person-month race × resource intersection now has replicate-weight uncertainty and status-flag filtering for three outcomes; still reconstruct full field universes, test household composition, mechanism, remedy, and downstream outcomes. |
