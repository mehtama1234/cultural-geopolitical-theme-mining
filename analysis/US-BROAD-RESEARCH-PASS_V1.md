...
Use the [broad counterexample register](US-BROAD-COUNTEREXAMPLE-REGISTER_V1.md)
to choose the reversal or boundary comparison before promoting a recurring
pattern into a trend claim.
...
The [SHED 2024–2025 panel persistence layer](projects/us-household-financial-pressure/shed-2024-2025-panel-persistence-layer-v1.md) adds the first same-respondent transition check: 4,419 recontacted respondents are followed across financial condition, price impact, adaptations, and emergency capacity. Its recovery view identifies both adaptation endings and continued adaptation among improving respondents, without claiming a dated price cause or a later trust/political effect.

The [SHED panel adaptation by financial-condition path layer](projects/us-household-financial-pressure/shed-panel-adaptation-condition-path-layer-v1.md) deepens that longitudinal pass by conditioning adaptation persistence and re-entry on whether the respondent's broad financial category worsened, stayed similar, or improved. It finds a descriptive persistence gradient while preserving selection, nonresponse, no-variance, and no-causal limits.

The [ANES panel judgment and action layer](projects/us-cost-trust-politics/anes-2024-panel-judgment-action-layer-v1.md) adds the next population-level bridge: pre-election financial worry is compared with institutional trust and post-election reported vote choice among the same multi-election panel respondents. It is temporal descriptive evidence, not a causal estimate, and the links from material exposure through attribution, identity, information, and action remain open.
...
The [BLS 2024 income-quintile spending layer](projects/us-household-financial-pressure/ce-2024-income-quintile-distribution-layer-v1.md) adds a distributional consumer anchor: income and expenditure changes differed across quintiles, and the lowest-quintile spending increase was concentrated in housing. It remains an average consumer-unit result, separate from household security, attribution, trust, and political action.

The [consumer-pressure, adaptation, and public-meaning cross-source bridge](projects/us-household-financial-pressure/consumer-pressure-distribution-adaptation-cross-source-bridge-v1.md) now places BLS, SHED, USDA food security, ATUS time, SIPP SNAP, local capacity, and political layers on one societal map. It identifies differentiated adaptation—spending mix, reduced use, delay, saving cuts, borrowing, extra work, unpaid help, and basic-security loss—while keeping the cross-source joins and downstream meaning/action arrows open.
...
The [SHED panel income × condition-path layer](projects/us-household-financial-pressure/shed-panel-income-condition-path-layer-v1.md) adds the next intersectional depth check. Among 4,419 recontacted respondents, it compares adaptation persistence and re-entry across under-$50k, $50k–$99k, and $100k+ income bands and worsening, stable, or improving financial-condition paths. Non-monotonic cells are retained as evidence of composition and mechanism limits, not smoothed into a simple income story.
...
The [AI infrastructure realization and control layer](projects/ai-work-control/ai-infrastructure-realization-control-layer-v1.md) deepens that cross-border stream with dated milestones and an ownership transition. It now records ADR's September 2026 completion announcement for Romania's underlying cloud infrastructure separately from the still-unverified 30-application migration and citizen-service outcomes; it also separates Malaysia's first 25MW handover from the planned 300MW campus and later Yondr-to-Vantage sale. Service quality, local incidence, portability, and state bargaining remain explicit tests.
...
The [current-vintage work-limiting-condition finding](projects/us-household-calendar-integration/findings/us-household-calendar-integration-023.md) refreshes that pass on the v16 extract. Because the results are not numerically identical to the earlier v10 output, both vintages and their boundaries remain visible rather than being collapsed into one trend.
