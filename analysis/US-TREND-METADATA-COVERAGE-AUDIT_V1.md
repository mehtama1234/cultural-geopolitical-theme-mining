...
- Trend records: **288**
- Observations: **1031**
- Distinct observation source URLs: **315**

## Required-field coverage

| Level | Field | Present | Coverage |
|---|---|---:|---:|
| record | `trend_id` | 288 | 100.0% |
| record | `title` | 288 | 100.0% |
| record | `theme_ids` | 288 | 100.0% |
| record | `program_theme_ids` | 288 | 100.0% |
| record | `source_unit` | 288 | 100.0% |
| record | `geography` | 288 | 100.0% |
| record | `observations` | 288 | 100.0% |
| record | `boundary` | 288 | 100.0% |
| observation | `period` | 1031 | 100.0% |
| observation | `denominator` | 1031 | 100.0% |
| observation | `measures` | 1031 | 100.0% |
| observation | `method` | 1031 | 100.0% |
| observation | `uncertainty` | 1031 | 100.0% |
| observation | `subgroup` | 1031 | 100.0% |
| observation | `counterinterpretation` | 1031 | 100.0% |
| observation | `source_url` | 1031 | 100.0% |
| observation | `retrieval_hash` | 1031 | 100.0% |
...
| Level | Field | Present | Coverage |
|---|---|---:|---:|
| record | `related_sources` | 228 | 79.2% |
| record | `retrieval_hash` | 24 | 8.3% |
| record | `reproduction_audit` | 30 | 10.4% |
...
All 1031 observations are expected to carry the required
