...
- Trend records: **285**
- Observations: **1028**
- Distinct observation source URLs: **312**

## Required-field coverage

| Level | Field | Present | Coverage |
|---|---|---:|---:|
| record | `trend_id` | 285 | 100.0% |
| record | `title` | 285 | 100.0% |
| record | `theme_ids` | 285 | 100.0% |
| record | `program_theme_ids` | 285 | 100.0% |
| record | `source_unit` | 285 | 100.0% |
| record | `geography` | 285 | 100.0% |
| record | `observations` | 285 | 100.0% |
| record | `boundary` | 285 | 100.0% |
| observation | `period` | 1028 | 100.0% |
| observation | `denominator` | 1028 | 100.0% |
| observation | `measures` | 1028 | 100.0% |
| observation | `method` | 1028 | 100.0% |
| observation | `uncertainty` | 1028 | 100.0% |
| observation | `subgroup` | 1028 | 100.0% |
| observation | `counterinterpretation` | 1028 | 100.0% |
| observation | `source_url` | 1028 | 100.0% |
| observation | `retrieval_hash` | 1028 | 100.0% |
...
| Level | Field | Present | Coverage |
|---|---|---:|---:|
| record | `related_sources` | 225 | 78.9% |
| record | `retrieval_hash` | 24 | 8.4% |
| record | `reproduction_audit` | 27 | 9.5% |
...
All 1028 observations are expected to carry the required
