...
**Source families recorded:** BEA: 3; BIS: 1; BLS: 14; CFPB: 19; CMS: 1; Census: 15; DOE: 15; EIA: 20; FTC: 27; Federal Reserve: 21; HBS: 47; HHS: 8; IEA: 1; IMF: 1; NBER: 147; OFR: 1; Other: 39; Other government: 26; Pew Research: 4; SBA: 2; Treasury: 2; World Bank: 3
...
**Open gaps:**
- the cost of care by family income and local price;
- whether workers reduce hours, leave jobs, or lose promotions;
- health effects on the caregiver and the older person;
- who can buy paid help and who relies on family;
- employer leave, scheduling, and benefit rules;
...
## US AI emotional support and the private care gap

**Project:** `us-ai-emotional-support-apps`

**Status:** short discovery pass; no settled finding

**Question:** What happens when an AI companion or wellness app becomes a person's place for emotional support?
...
**Open gaps:**
- US users' outcomes over months or years;
- effects by age, income, loneliness, disability and crisis history;
- whether users know the app's limits;
- crisis detection and referral to human care;
- retention, payment and business incentives;
...
**Project:** `us-digital-habits-attention`

**Status:** short discovery pass; no settled finding

**Question:** Do digital products turn attention and emotional trust into longer use, and can people leave without pressure or loss?
...
- how medical debt changes credit, housing, work, or insurance after a bill;
...
**Question:** Do payment and credit products lower the visible barrier to purchase while moving cost and risk toward households with less liquidity, weaker credit access, or fewer ways to avoid the system?
...
**Project:** `us-housing-insurance-risk`
...
**Question:** Does the movement of small-business owners and firms change local opportunity and belonging, or does a new business simply replace the old one?
...
**Open gaps:**
- lasting firms versus applications and temporary closures;
- who owns the businesses and where the owners live;
- local credit, rent, labor, and customer conditions;
- changes in essential services and prices;
- worker and customer experience after closure or relocation;
...
- differences among receipts, location, health and financial data;
- whether privacy rules change prices, offers or service quality;
- which firms gain the most from the extra data;
...
**Project:** `us-review-outcomes-returns`

**Status:** matched evidence pass complete; joined review-to-outcome evidence remains open
...
## US utility debt and household mobility

**Project:** `us-utility-debt-mobility`

**Status:** matched evidence pass complete; customer-level move and connection outcomes remain open

**Question:** When a household leaves an address with an unpaid utility balance, does the debt become a collection record, a new deposit, or a barrier to service at the next address?
...
- [FTC: debt collection FAQs](https://consumer.ftc.gov/articles/debt-collection-faqs)
- [EIA: Household energy insecurity, 2024](https://www.eia.gov/consumption/residential/data/2024/hc/pdf/HC11.1_2024.pdf)

[Open the source-search record](projects/us-utility-debt-mobility/source-search-2026-09-11.md)
