...
have exact registered-URL references. The trend registry holds 311 records and
1108 observations.
...
keep material security, institutional judgment, and political participation as
separate currencies; a dated coverage event, attribution, remedy, and recovery
remain open.
...
The Harvey recovery survey adds the judgment layer: 30% of affected residents
still reported disruption nearly a year later, 42% said they were not getting
needed help, and confidence that relief reached those most in need was lower
among more heavily affected groups. This is a descriptive legitimacy surface,
...
The same subscription finding now includes Uber One as a service-dependence
comparison: the FTC amended-complaint release alleges up to 23 cancellation
screens and 32 actions, alongside disputed savings and consent. This extends
...
uses two Facebook/Instagram field experiments to treat ad load, time share, and
opportunity cost as inputs into demand and substitution. It does not establish
that time spent is harmful or that a modeled de-merger would improve welfare.
The next test is a small consented time-use panel with work, care, sleep,
offline alternatives, accessibility, switching, and perceived benefit/burden;
do not scrape platform data or download large files.
...
The detailed practical-exit finding extends this comparison to ten routes by
adding the Doxo bill-payment enforcement case and Grubhub's aggregate remedy
program, plus the VRURC recall implementation bridge and Amazon Flex tip-refund
...
5. [MEPS episode-field availability boundary](projects/us-health-cost-household-choice/findings/us-health-cost-household-choice-013.md): a large dated event scaffold is available, but alternatives, event-specific choice, verified remedy, and meaning/action follow-up are missing.
...
does not establish causal AI displacement, productivity, household welfare,
trust, or political response. The next test remains a longitudinal worker
design with job event, employer policy, task control, schedule, pay, benefit,
remedy, and later movement in the same unit.
