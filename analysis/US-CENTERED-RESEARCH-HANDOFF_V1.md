...
Start with [the HTML guide](../site/us-theme-atlas.html) and its [Markdown edition](us-theme-atlas.md). Fifty-three topics now sit under five shared themes, with seventy-four explained cross-topic connections. Each topic includes subthemes, sources and limits. Connections are labeled as comparisons or questions to test; they are not established causes.
...
Forty-four reading paths now link household costs and care, family time and economic views, continued contact and trust, worker AI access and customer attention, housing costs and economic views, energy costs and the household budget, household bills and credit, budget pressure and food, food need and public help, family care and paid work, home energy and transportation, service problems and fraud recovery, education debt with housing choices, household actions with public trust, unpaid eldercare with paid work, housing with local business control, home energy with housing and credit, worker AI with service remedy, workplace speech with work and service, career movement with debt and housing, employee ownership with work and household money, and remote contact with work and transport, and habit change with attention and service, and subscriptions with household money and political trust, and aid design with public programs and food, and price perception with household money and political trust, and tariffs with price perception and household money, and multiple jobs with work and household money, and bank staying with household money and financial trust, and privacy with service and public trust, and real wages with price perception and household money, and hometown ownership with place and housing, and household rate response with price perception and household money, and older customers with care and household money, and AI emotional support with attention and service, and vehicle repair with transport and work, and family support with care and household money, and owner households with work and household money, and benefit loss with aid and work, and utility timing with energy and household money, and health coverage with work and household money, and medical debt relief with credit and household money, and cash aid with housing and household structure, and benefit loss with public mood and political judgment, and income risk with work and household money, and durable purchases with credit and household money, and guaranteed income with care and household money, and immigration with place and housing, and hidden fees with price perception and household money, and payment fees with price perception and household money, and credit visibility with credit and housing, and eviction with housing and credit. Each path explains its shared question and missing evidence. Every adjacent pair must have a recorded connection; the builder checks this. These paths guide reading, not causal conclusions.
...
Keep research passes short. Add a supported finding, a useful connection, or a clear unresolved question, then move to the next topic. The fifty-three opening packets exist; the next work is checking their strongest claims and connections, not recreating project briefs.
