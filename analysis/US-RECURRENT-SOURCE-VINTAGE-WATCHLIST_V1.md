...
| BLS Consumer Expenditure Surveys | 2024 annual release; 2025 annual release not yet located in the official release index on September 17, 2026 | Next annual release; date not fixed in this atlas | Recheck the CE annual release page and preserve consumer-unit, income, expenditure-component, and quintile universes; do not infer 2025 spending distribution from retail sales or CPI | Average consumer-unit spending and quintile tables are not household panels, liquid room, price-adjusted welfare, or causal adaptation |
