...
**Registry checkpoint:** 310 canonical records, 1103 observations, 14 program
...
- [Expanding a small-business boundary can redistribute opportunity toward scale](analysis/projects/us-small-business-support-size-cutoff/findings/us-small-business-support-size-rule-001.md): eligibility expansion, contract reallocation, small-firm exit, wages, patenting, and the still-open customer/household consequences.
...
19. **Diversity has broad approval but contested institutional meaning:** most
   Americans see racial and ethnic diversity as good for the country, while
...
- [Credit Karma financial-access refund implementation](site/us-customer-automation-recourse-024.html):
  “pre-approved” marketing, application time, and possible credit exposure are
  linked to refunds; score repair, receipt, and restored opportunity remain open.
- [First American payment-processor refund implementation](site/us-customer-automation-recourse-025.html):
  hidden and early-termination fees are linked to small-business remedy; cashing,
  processor switching, continuity, and practical exit remain open.
...
- [Owner-household business bridge](site/us-owner-business-revenue-consumption-covid-001.html):
  linked accounts show a 40% early COVID business-revenue fall with a 1.6-cent
  owner-consumption pass-through per dollar lost; buffers, survival, workers,
  customers, and political meaning remain open.
...
- [CCES panel insurance-status follow-up](site/us-cost-trust-politics-030.html):
  earlier noncoverage precedes lower later contact/action but near-similar
  favorable Congress approval; coverage event and attribution remain open.
- [CPSC hazard, recall, and remedy layer](site/cpsc-hazard-recall-remedy-layer-v1.html):
  ...
  reach, household action, remedy, and avoided harm remain open.
...
- [CPSC hazard, recall, and remedy layer](analysis/projects/us-marketplace-product-safety/cpsc-hazard-recall-remedy-layer-v1.md): recalls, e-commerce takedowns, import examinations, and injury surveillance make institutional intervention visible, while notice reach, remedy receipt, avoided harm, and household recovery remain open.
...
- [Realized infrastructure and state-capability record](analysis/records/us-defense-procurement-realization-milestones-2024-2026.json), the [JASSM/LRASM production-integration realization record](analysis/records/us-jassm-lrasm-production-integration-realization-2024-2025.json), and its [bounded milestone finding](analysis/projects/ai-work-control/findings/ai-work-control-080.md): commitment, delivery, operation, supplier control, and external leverage remain distinct stages.
...
- [Pew 2026 press-government legitimacy layer](analysis/projects/us-digital-habits-attention/pew-2026-press-government-media-legitimacy-layer-v1.md): Americans broadly describe the administration-news relationship as bad, but divide over media power and the acceptable direction of criticism; exposure, accuracy, censorship, switching, and political action remain open.
- [Gallup 2026 institutional-confidence divergence layer](analysis/projects/us-cost-trust-politics/gallup-2026-institutional-confidence-divergence-layer-v1.md): average confidence remains near historic lows while small business, large technology companies, and presidency confidence move on sharply different legitimacy surfaces; use, dependence, switching, and action remain open.
...
- [Pew 2026 national mood and future-expectations layer](analysis/projects/us-cost-trust-politics/pew-2026-national-mood-future-expectations-layer-v1.md): current dissatisfaction and weak institutional expectations coexist with personal hope, improving long-run expectations, and cross-partisan expectation of greater future division.
- [Pew 2026 political typology, values, and coalition layer](analysis/projects/us-cost-trust-politics/pew-2026-political-typology-values-coalitions-layer-v1.md): nine value-based groups reveal cross-pressured economic, cultural, institutional, and geopolitical coalitions beneath the two-party surface.
- [Pew 2026 midterm economy and political-attribution layer](analysis/projects/us-cost-trust-politics/pew-2026-midterm-economy-political-attribution-layer-v1.md): affordability is the leading campaign topic while neither party has a clear economic advantage and 51% see neither party as representing them on AI.
- [EIA 2024 household energy-insecurity consequence layer](analysis/projects/us-repeat-energy-crises/eia-2024-household-energy-insecurity-consequence-layer-v1.md): energy pressure appears as food/medicine sacrifice, unhealthy temperatures, notices, and unusable equipment, with overlapping household-level routes rather than one hardship score.
- [Pew 2026 Hispanic identity, advantage, and barrier layer](analysis/projects/us-immigration-local-demand/pew-2026-hispanic-identity-advantage-barrier-layer-v1.md): identity is central for many Hispanic adults but is interpreted as connection, advantage, barrier, or discrimination differently by party, vote, and immigrant generation.
- [Census Vintage 2025 population slowdown and migration geography layer](analysis/projects/us-immigration-local-demand/census-2025-population-slowdown-migration-geography-layer-v1.md): national and metro growth slowed while migration components redistributed population across counties and regions.
- [GAO 2026 FEMA disaster-assistance delivery and capacity layer](analysis/projects/us-repeat-energy-crises/gao-2026-fema-disaster-assistance-delivery-capacity-layer-v1.md): aggregate assistance scale coexists with access, communication, housing, and state/local capacity bottlenecks.
- [GAO 2026 EDA disaster-economic recovery outcomes layer](analysis/projects/us-repeat-energy-crises/gao-2026-eda-disaster-economic-recovery-outcomes-layer-v1.md): federal coordination and infrastructure funding are visible, but current measures cannot establish intended economic outcomes; a bounded 292-grant result is preserved without calling it a portfolio failure rate.
- [GAO 2026 disaster-assistance scams, information, and trust layer](analysis/projects/us-repeat-energy-crises/gao-2026-disaster-assistance-scams-information-trust-layer-v1.md): urgent aid creates a verification and reporting problem; prevalence, losses, warning receipt, and trust effects remain unmeasured because complaint data are incomplete.
- [GAO/USGS 2026 critical-minerals dependence layer](analysis/projects/ai-work-control/gao-2026-critical-minerals-substitution-recycling-dependence-layer-v1.md): import reliance becomes a capability question across batteries, semiconductors, recycling, substitution, processing, and geopolitical leverage; domestic production alone is not treated as autonomy.
- [GAO 2026 CHIPS R&D capacity and governance layer](analysis/projects/ai-work-control/gao-2026-chips-rd-capacity-governance-dependence-layer-v1.md): semiconductor awards and milestones progress while R&D vehicles are canceled or redesigned; disbursement, workforce activity, operating capacity, statutory alignment, and strategic autonomy remain distinct.
- [DOE 2026 transmission-needs and large-load layer](analysis/projects/ai-work-control/doe-2026-transmission-needs-data-center-manufacturing-load-layer-v1.md): data centers, manufacturing, and electrification turn AI/industrial ambition into transmission, congestion, rate, reliability, local-burden, and public-governance questions.
- [Census 2025 child-care challenges and work-adaptation layer](analysis/projects/us-aging-care-strain/census-2025-childcare-challenges-work-adaptation-layer-v1.md): paid care, care-access problems, 65.8 average lost workdays among affected households, and income-stratified adaptation reveal care as labor-market infrastructure.
- [GAO 2026 military child-care workforce and capacity layer](analysis/projects/us-aging-care-strain/gao-2026-military-childcare-workforce-capacity-layer-v1.md): DOD’s 19,000-worker, 172,000-child system still faces waitlists; incentives, staffed slots, fee discounts, worker retention, and family work outcomes remain distinct.
...
- [MEPS dated event-to-household-response screen](analysis/projects/us-household-constraint-cascade/meps-dated-cascade-event-screen-v1.md): first inter-round events are placed beside same-person care delay, bill problems, medical debt, collector contact, and R4/2 nonemployment without mixing ESAQ weights into the event variance design.
- [MEPS dated event plus institutional-friction cascade](analysis/projects/us-household-constraint-cascade/meps-dated-friction-cascade-v1.md): strict-window denial/prior-authorization comparisons now sit beside same-person care-delay, bill, debt, and collector context across office, ER, and inpatient events.
...
- [Next acquisition decision](analysis/projects/us-household-constraint-cascade/next-acquisition-decision-v1.md): a storage-conscious UAS go/no-go route, now prioritizing the narrower Older Ages event-first panel before the broader Monthly Panel or UAS 537/698; no new microdata are downloaded in the current pass.
...
**What is established:** recorded SNAP entry and exit reasons have distinct
...
## Route 3: health cost is not one burden
...
in one uniform perceived-health direction. The separate same-round record
...
remedy, and changing data fields can change the apparent trend.
...
**What is established:** same-respondent and repeated-year GSS layers show
...
**What is established:** the atlas can compare recipient concentration and
...
aggregate establishment mobility; and BFS/BDS separates business intent from
...
1. What is the unit: person, household, event, firm, place, institution, or
   country?
2. What is the clock and what is merely adjacent record order?
3. What alternative or control is actually observed?
4. Which arrow is measured, which is descriptive, and which remains open?
5. What smallest same-unit acquisition would close the next arrow?

The [full review guide](REVIEW-GUIDE_V1.md) and [current status audit](analysis/US-BROAD-CURRENT-STATUS-AUDIT_V1.md)
provide the complete inventory and publication controls.
