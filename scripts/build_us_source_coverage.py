...
html = html.replace('<nav><a href="index.html">Research home</a> / source coverage</nav>', '<nav><a href="index.html">Research home</a> · <a href="us-theme-atlas.html">Connections</a> · <a href="us-big-picture-synthesis.html">Big picture</a> · <a href="us-evidence-audit.html">Evidence audit</a> / source coverage</nav>')
