...
for path in paths:
    ...
    path_cards.append(f'<article class="path"><h3>{e(path["title"])}</h3><p>{e(path["meaning"])}</p><ol>{steps}</ol><p class="limit"><strong>Still missing:</strong> {e(path["limit"])}</p></article>')
