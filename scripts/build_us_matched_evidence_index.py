...
for path in sorted((ROOT / "analysis/findings").glob("*-matched-evidence-001.md")):
    ...
    items.append({"key": key, "title": title, "short": short, "theme": theme, "route": route, "open": open_question, "html": f"{key}.html", "md": str(path.relative_to(ROOT / "analysis"))})
assert items
