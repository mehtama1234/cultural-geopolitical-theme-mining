...
The next short pass is [US returns, complaints, and the reality behind reviews](analysis/projects/us-review-outcomes-returns/README.md), with its [source search record](analysis/projects/us-review-outcomes-returns/source-search-2026-09-11.md). It tests whether visible review trust matches what happens after the purchase.
...
The next short pass is [US product recalls and household response](analysis/projects/us-product-recall-response/README.md), with its [source search record](analysis/projects/us-product-recall-response/source-search-2026-09-11.md). It tests whether a recall notice becomes a real household action and remedy.

The next short pass is [US repair access and household cost](analysis/projects/us-right-to-repair-household-cost/README.md), with its [source search record](analysis/projects/us-right-to-repair-household-cost/source-search-2026-09-11.md). It tests whether a broken product can be repaired at a fair cost or pushes the household toward replacement.
...
The next short project is [US safe temperature and energy insecurity](analysis/projects/us-safe-temperature-energy-insecurity/README.md), with its [source search record](analysis/projects/us-safe-temperature-energy-insecurity/source-search-2026-09-11.md). It tests how energy cost or equipment failure becomes an unsafe home, a food or medicine tradeoff, or a shutoff risk.
...
The next short project is [US utility entry costs and credit screening](analysis/projects/us-utility-entry-cost-credit-screening/README.md), with its [source search record](analysis/projects/us-utility-entry-cost-credit-screening/source-search-2026-09-11.md). It tests whether deposits, late fees, and utility credit checks block basic service before the first bill.

The next short project is [US utility debt and household mobility](analysis/projects/us-utility-debt-mobility/README.md), with its [source search record](analysis/projects/us-utility-debt-mobility/source-search-2026-09-11.md). It tests whether an old utility balance becomes a collection record, a new deposit, or a service barrier at the next address.

The next short project is [US utility shutoff and reconnection rules](analysis/projects/us-utility-shutoff-reconnection-rules/README.md), with its [source search record](analysis/projects/us-utility-shutoff-reconnection-rules/source-search-2026-09-11.md). It tests how notice, payment arrangements, protections, and reconnection costs change the household path after nonpayment.

The next short project is [US housing type and energy affordability](analysis/projects/us-housing-type-energy-affordability/README.md), with its [source search record](analysis/projects/us-housing-type-energy-affordability/source-search-2026-09-11.md). It tests how renters, manufactured-home residents, and homeowners differ in cost, repair control, and recovery.
